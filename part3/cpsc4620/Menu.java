...
public class Menu {
		...
		try {
			...
			while (!all_pizza_added) {
				...
				while (!add_another_answer) {
					System.out.print("Would You Like To Add Another Pizza? Y/N: ");

					String response = reader.nextLine().toLowerCase(Locale.ROOT);
			...
			System.out.print("Should any discounts be added for this whole order? Y/N: ");
	...
	public static Order addDinein(Customer c) {
		...
		try {
			...
			System.out.print("Enter order placed date (in format yyyy-MM-dd HH:mm:ss - 24 hour format): ");
			...
			o = new DineinOrder(-1, 0, date, 0, 0, false, tableNum);
	...
	public static Order addPickup(Customer c) {
		...
		System.out.print("Please enter the time you will pick it up (in yyyy-MM-dd HH:mm:ss [24 hour] format): ");
	...
	public static Customer EnterCustomer() throws SQLException, IOException {
		...
		System.out.print("Please Enter 10-digit Customer phone number (without any spaces or special character in between): ");
		...
		System.out.print("Is this a customer who wants delivery? Y/N: ");
	...
	public static void addCustomerAddress(Customer c) {
		...
		System.out.print("Please enter the street and house humber: ");
		street = reader.nextLine();

		System.out.print("Please enter the city: ");
		city = reader.nextLine();

		System.out.print("Please enter the state (two letter abbreviation): ");
	...
	public static void MarkOrderAsComplete() throws SQLException, IOException {
		...
		try {
			...
			System.out.print("Which order would you like mark as complete? Enter the number: ");
	...
	public static void AddInventory() throws SQLException, IOException {
		...
		try {
			...
			System.out.print("Which topping's inventory's would you like to update (Use number) : ");
			...
			while (topID < 1 || topID > curInventory.size()) {
				...
				System.out.print("Which topping's inventory's would you like to update : ");
			...
			while (add <= 0) {
				System.out.print("You cannot update inventory in negative or zero.\nHow much you want to update : ");
	...
	public static Pizza buildPizza(Order o) throws SQLException, IOException {
		...
		try {
			...
			//select size
			System.out.print("What size is the pizza? \n1.) Small \n2.) Medium\n3.) Large\n4.) X-Large \n Enter the corresponding number: ");
			...
			//select crust
			System.out.print("What crust for this pizza? \n1.) Thin \n2.) Original\n3.) Pan\n4.) Gluten-Free \n Enter the corresponding number: ");
			...
			newPizza = new Pizza(-1, size, crust, o.getOrderID(), DBNinja.order_notComplete, o.getDate(), base_price, base_cost);
			...
			while (chosen_t != -1) {
				...
				System.out.print("Which topping do you want to add? Enter the number. Enter -1 to stop adding toppings: ");
			...
			System.out.print("Should any discounts be added for this pizza? Enter Y or N: ");
			String yn = reader.nextLine().toLowerCase(Locale.ROOT);
			if (yn.equals("y")) {
				// add discounts
				int chosen_d = 0;
